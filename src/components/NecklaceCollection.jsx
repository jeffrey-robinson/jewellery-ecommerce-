    ...
    <div className="bg-[#FCF8F2] min-h-screen text-[#211522] pb-24">
      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-8 mt-16 lg:mt-24">
        <div className="border-b border-[#E8D8EE] pb-6 mb-12 flex justify-between items-end">
          <div>
            <h2 className="font-display text-2xl text-[#211522] font-semibold">Explore Pendants & Chains</h2>
            <p className="text-xs text-[#211522]/50 mt-1 font-body">Premium finishes crafted for daily wear and structural brilliance</p>
          </div>
