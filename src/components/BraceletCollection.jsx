  ...
  return (
    <div className="bg-ivory min-h-screen text-ink pb-24">
      ...
      <section className="bg-ink text-ivory py-20 relative overflow-hidden">
        ...
        <div className="pointer-events-none absolute -top-16 -left-10 h-64 w-64 rounded-full bg-sapphire/10 blur-3xl animate-drift-slow" />
      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-8 mt-16 lg:mt-24">
        <div className="border-b border-ink/10 pb-6 mb-12 flex justify-between items-end">
          <div>
            <h2 className="font-display text-2xl text-ink">Explore Charm & Link Bracelets</h2>
            <p className="text-xs text-ink/50 mt-1 font-body">Refined details, sparkling charms, and comfort-fit closures</p>
          </div>
