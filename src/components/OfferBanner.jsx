...
export default function OfferBanner() {
  return (
    <section className="relative overflow-hidden bg-ink">
      ...
      <div className="absolute -bottom-16 -right-16 h-64 w-64 facet-badge bg-white/10" />
      <div className="absolute -top-10 left-10 h-32 w-32 facet-badge bg-white/10 hidden sm:block" />
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 py-16 sm:py-20 flex flex-col lg:flex-row items-center justify-between gap-8 text-center lg:text-left">
        <div>
          <span className="text-xs font-semibold tracking-[0.18em] text-white/80">LIMITED TIME</span>
        ...
        <a
          href="#products"
          className="group inline-flex items-center gap-2 bg-white text-ink px-8 py-4 rounded-full font-medium text-sm hover:bg-gold hover:text-ink transition-colors duration-300 shrink-0"
        >
          Claim the Offer
