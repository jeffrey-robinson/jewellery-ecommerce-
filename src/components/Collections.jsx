  ...
  return (
    <div className="bg-ivory min-h-screen text-ink pb-24">
      ...
      <section className="bg-ink text-ivory py-20 relative overflow-hidden">
        ...
        <div className="pointer-events-none absolute -top-24 -left-16 h-72 w-72 rounded-full bg-gold/10 blur-3xl animate-drift-slow" />
        <div className="pointer-events-none absolute -bottom-24 -right-10 h-80 w-80 rounded-full bg-ruby/10 blur-3xl animate-drift" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 perspective-1000">
          {customCollections.map((c) => (
            <TiltCard
              ...
              key={c.name}
              max={7}
              className="group relative rounded-3xl overflow-hidden bg-white border border-ink/5 hover:border-gold/20 transition-colors duration-500 flex flex-col justify-between shadow-soft-3d"
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${colorThemes[c.color]} opacity-70 z-10`} />
              <div className="relative aspect-[4/5] overflow-hidden bg-ivory tilt-layer-deep shadow-sm">
                <img
                  src={c.img}
                  alt={c.name}
              ...
              <div className="relative p-5 bg-white z-20 flex items-center justify-between border-t border-ink/5 tilt-layer-inner">
                <div>
